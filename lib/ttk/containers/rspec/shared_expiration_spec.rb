...
#
RSpec.shared_examples 'expiration interface - year 1970' do
  describe '#year' do
    it 'returns an integer' do
      expect(expiration.year).to be_kind_of(Numeric)
    end
...
RSpec.shared_examples 'expiration interface - month 1' do
  describe '#month' do
    it 'returns an integer' do
      expect(expiration.month).to be_kind_of(Numeric)
    end
...
RSpec.shared_examples 'expiration interface - day 1' do
  describe '#day' do
    it 'returns an integer' do
      expect(expiration.day).to be_kind_of(Numeric)
    end
