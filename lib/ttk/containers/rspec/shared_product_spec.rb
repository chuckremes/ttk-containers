...
RSpec.shared_examples 'product interface - osi call' do
  context 'single digit strike' do
    ...
    it 'returns SPY---211211C00007000' do
      expect(product.osi).to eq 'SPY---211211C00007000'
    end

    it 'returns a 21-char string' do
      expect(product.osi.size).to eq 21
    end
  end
  ...
  context '2 digit strike' do
    ...
    it 'returns SPY---211211C00071000' do
      expect(product.osi).to eq 'SPY---211211C00071000'
    end
  ...
  context '3 digit strike' do
    ...
    it 'returns SPY---211211C00712000' do
      expect(product.osi).to eq 'SPY---211211C00712000'
    end
  ...
  context '4 digit strike' do
    ...
    it 'returns SPY---211211C07123000' do
      expect(product.osi).to eq 'SPY---211211C07123000'
    end
  ...
  context '5 digit strike' do
    ...
    it 'returns SPY---211211C71234000' do
      expect(product.osi).to eq 'SPY---211211C71234000'
    end
...
RSpec.shared_examples 'product interface - osi put' do
  context 'single digit strike' do
    ...
    it 'returns SPY---211211P00007000' do
      expect(product.osi).to eq 'SPY---211211P00007000'
    end
  ...
  context '2 digit strike' do
    ...
    it 'returns SPY---211211P00071000' do
      expect(product.osi).to eq 'SPY---211211P00071000'
    end
  ...
  context '3 digit strike' do
    ...
    it 'returns SPY---211211P00712000' do
      expect(product.osi).to eq 'SPY---211211P00712000'
    end
  ...
  context '4 digit strike' do
    ...
    it 'returns SPY---211211P07123000' do
      expect(product.osi).to eq 'SPY---211211P07123000'
    end
  ...
  context '5 digit strike' do
    ...
    it 'returns SPY---211211P71234000' do
      expect(product.osi).to eq 'SPY---211211P71234000'
    end
...
RSpec.shared_examples 'product interface - put' do
  describe '#call?' do
    it 'returns false' do
      expect(product.call?).to be false
    end
  end

  describe '#put?' do
    it 'returns true' do
      expect(product.put?).to be true
    end
  end
...
RSpec.shared_examples 'product interface - equity' do
  ...
  describe '#equity_option?' do
    it 'returns false' do
      expect(product.equity_option?).to be false
    end
  end

  describe '#equity?' do
    it 'returns true' do
      expect(product.equity?).to be true
    end
  end

  describe '#strike' do
    it 'returns 0' do
      expect(product.strike).to eq 0
    end
  end
