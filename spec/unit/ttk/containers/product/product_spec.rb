...
RSpec.describe TTK::Containers::Product::Example do
  ...
  subject(:container) do
    ...
    make_product(klass: described_class, symbol: symbol, strike: strike, callput: callput, security_type: security_type, expiration_date: expiration)
  end
  ...
  let(:different_duplicate) do
    ...
    make_product(klass: described_class, symbol: symbol2, strike: strike, callput: callput, security_type: security_type, expiration_date: expiration)
  end
